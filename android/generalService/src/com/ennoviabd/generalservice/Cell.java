...
public class Cell {
	...
	protected int mYear=2011;
	protected int mIsScheduleDay=0;
	protected Paint mPaint = new Paint(Paint.SUBPIXEL_TEXT_FLAG |Paint.ANTI_ALIAS_FLAG);
	int dx, dy;
	public Cell(int dayOfMon,int m,int y, Rect rect, float textSize, boolean bold) {
	...
	public Cell(int dayOfMon,int m,int y, Rect rect, float textSize) {
		this(dayOfMon,m,y, rect, textSize, false);
	}

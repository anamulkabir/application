...
import static com.android.calendarDemo.CalendarController.EVENT_EDIT_ON_LAUNCH;
...
import com.android.calendarDemo.CalendarController.EventInfo;
import com.android.calendarDemo.CalendarController.EventType;
import com.android.calendarDemo.CalendarEventModel.Attendee;
import com.android.calendarDemo.CalendarEventModel.ReminderEntry;
import com.android.calendarDemo.alerts.QuickResponseActivity;
import com.android.calendarDemo.event.AttendeesView;
import com.android.calendarDemo.event.EditEventActivity;
import com.android.calendarDemo.event.EditEventHelper;
import com.android.calendarDemo.event.EventViewUtils;
...
public class EventInfoFragment extends DialogFragment implements OnCheckedChangeListener,
    ...
    private static final String[] EVENT_PROJECTION = new String[] {
        ...
        Events.CALENDAR_COLOR,        // 11 If SDK < 16, set to Calendars.CALENDAR_COLOR.
    ...
    private static final String[] ATTENDEES_PROJECTION = new String[] {
        ...
        //Attendees.ATTENDEE_STATUS_ACCEPTED,        // 5
        Attendees._COUNT     // 6
    };
    ...
    private void updateCustomAppButton() {
        buttonSetup: {
            ...
            Uri uri = ContentUris.withAppendedId(Events.CONTENT_URI, mEventId);
           final Intent intent = new Intent(CalendarContract.ACTION_EVENT_REMINDER, uri);

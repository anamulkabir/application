...
public class GpsHandler extends Service implements LocationListener {
            ...
            if (!isGPSEnabled && !isNetworkEnabled) {
                ...
                if (isGPSEnabled) {
                    if (location == null) {
                        ...
                        Toast.makeText(mContext, "GPS Enable", Toast.LENGTH_SHORT).show();
                        if (lManager != null) {
    ...
    public void stopUsingGPS(){
        if(lManager != null){
            lManager.removeUpdates(GpsHandler.this);
        }      
    }
    ...
    public void onLocationChanged(Location location) {
    	...
    	latitude= location.getLatitude();
	    longitude= location.getLongitude();
	    Toast.makeText(mContext,"location change- Latitude:"+latitude+" longitude:"+longitude, Toast.LENGTH_SHORT);

...
final class g729a_qua_lsp implements g729a_constants
{
	...
	for (i = 0; i < 2; i++) {
		...
		fs_1_[i][i_68_]
		    = (g729a_tables.g729a_lspcb1[10 * i_39_ + i_68_]
		       + g729a_tables.g729a_lspcb2[10 * i_63_ + i_68_]);
	    for (int i_69_ = 5; i_69_ < 10; i_69_++)
		fs_1_[i][i_69_]
		    = (g729a_tables.g729a_lspcb1[10 * i_39_ + i_69_]
	...
	var_g729a_encode_lp.l_quant_past_frame_4
	    = var_g729a_encode_lp.l_quant_past_frame_3;
	var_g729a_encode_lp.l_quant_past_frame_3
	    = var_g729a_encode_lp.l_quant_past_frame_2;
	var_g729a_encode_lp.l_quant_past_frame_2
	    = var_g729a_encode_lp.l_quant_past_frame_1;
	...
	for (i = 0; i < 2; i++) {
		...
		fs_73_[i_74_ + i_85_]
		    = (fs_83_[i_84_ + i_85_] * fs_79_[i_85_]
	...
	for (int i_86_ = 0; i_86_ < 10; i_86_++) {
	    ...
	    var_g729a_encode_lp.q_quant_present_subframe_2[i_86_]
		= (float) ((double) g729a_tables.g729a_cos[i]

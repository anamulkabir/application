...
public class G711 implements Codec {
  private RTPHandler rtpHandler;

  public G711(RTPHandler rtpHandler) {
  ...
  public byte[] encode(short samples[], int off, int len) {
    ...
    rtpHandler.buildRTPHeader(encoded, 0, rtpHandler.getSeqNumber(), rtpHandler.getTimeStamp(), rtpHandler.getSsrc());

...
public class EarthquakeProvider extends ContentProvider {
	public static final Uri CONTENT_URI =
			Uri.parse("content://com.ennoviabd.app.earthquake/earthquakes");
	...
	uriMatcher.addURI("com.ennoviabd.app.earthquake.Earthquake", "earthquakes",	QUAKES);
	uriMatcher.addURI("com.ennoviabd.app.earthquake.Earthquake", "earthquakes/#",	QUAKE_ID);
	}
	...
	public String getType(Uri uri) {
		...
		case QUAKES:
		return "vnd.android.cursor.dir/vnd.ennoviabd.earthquake";
		case QUAKE_ID:
		return "vnd.android.cursor.item/vnd.ennoviabd.earthquake";
		default:
